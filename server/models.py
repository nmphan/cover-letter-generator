...
class Resume(Base, TimestampMixin):
    ...
    experience: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB)
    education: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB)
...
class JobDescription(Base, TimestampMixin):
    ...
    company_name: Mapped[Optional[str100]]
    location: Mapped[Optional[str100]]
    requirements: Mapped[Optional[List[str]]] = mapped_column(JSONB)
